...
# Cleanup script to delete all environments except for the most recent ones
# Usage: ./cleanup_environments.sh [keep_count]
...
# Confirm deletion
read -p "Delete these $DELETE_COUNT environments? (y/n): " CONFIRM
if [ "$CONFIRM" != "y" ]; then
